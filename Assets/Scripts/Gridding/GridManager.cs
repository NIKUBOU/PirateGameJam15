...
public class GridManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        InvokeRepeating("DevelopCities", timeBetweenCityExpansionCycles, timeBetweenCityExpansionCycles);
    }
    ...
    void GenerateGrid()
    {
        ...
        for (int x = 0; x < gridWidth; x++)
        {
            for (int z = 0; z < gridHeight; z++)
            {
                ...
                if (x == gridWidth-1 && z == gridHeight-1 && currentCities.Count < 1 && maxCitiesAtStart > 0)
                {
                    isCity = true;
                    currentCities.Add(spawnedTile);
                }
